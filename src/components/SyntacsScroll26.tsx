  ...
  return (
    <div ref={containerRef} className="relative h-[400vh] bg-white">
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        {isLoading && (
          <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-white" suppressHydrationWarning>
            <div className="w-12 h-12 border-4 border-slate-300 border-t-slate-900 rounded-full animate-spin mb-4" />
            <p className="text-slate-500 font-mono tracking-widest uppercase text-[10px] md:text-xs">
        ...
        <div className="absolute inset-0 pointer-events-none px-6">
          ...
          >
            <h2 className="text-4xl md:text-7xl font-bold tracking-tighter mb-6 md:mb-8 leading-none text-slate-900">
