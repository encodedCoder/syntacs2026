          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
            ...
            <div className="md:col-span-2">
              ...
              <ul className="space-y-4">
                <li><Link href="#welcome" className="text-sm text-white/40 hover:text-white transition-colors">About</Link></li>
                ...
                <li><Link href="#info" className="text-sm text-white/40 hover:text-white transition-colors">Venue</Link></li>
              </ul>
            </div>
