        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
            ...
            <div className="md:col-span-4">
              ...
              <p className="text-slate-600 text-sm leading-relaxed font-light mb-8 max-w-sm">
            ...
            <div className="md:col-span-2">
              <p className="text-[10px] uppercase tracking-[0.4em] text-slate-400 font-mono mb-8">Navigation</p>
              <ul className="space-y-4">
                <li><Link href="/" className="text-sm text-slate-600 hover:text-slate-900 transition-colors">Home</Link></li>
                <li><Link href="/keynotes" className="text-sm text-slate-600 hover:text-slate-900 transition-colors">Keynotes</Link></li>
                <li><Link href="/program" className="text-sm text-slate-600 hover:text-slate-900 transition-colors">Program</Link></li>
                <li><Link href="/venue" className="text-sm text-slate-600 hover:text-slate-900 transition-colors">Venue</Link></li>
              </ul>
            </div>

            {/* Contact Details */}
            <div className="md:col-span-3">
              <p className="text-[10px] uppercase tracking-[0.4em] text-slate-400 font-mono mb-8">Contact Details</p>
              <div className="space-y-6">
                ...
                <div className="flex gap-4 items-center">
                  ...
                  <a href="mailto:cseoffice@iitrpr.ac.in" className="text-sm text-slate-600 hover:text-slate-900 transition-colors">cseoffice@iitrpr.ac.in</a>
                </div>
              </div>
            </div>
            ...
            {/* Location / CTA */}
            <div className="md:col-span-3">
              <p className="text-[10px] uppercase tracking-[0.4em] text-slate-400 font-mono mb-8">Location</p>
          ...
          <div className="pt-12 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex items-center gap-6">
              <span className="text-slate-400 text-[10px] font-mono uppercase tracking-[0.2em]">
                Designed by <a href="https://encodedcoder.com" target="_blank" className="text-slate-600 hover:text-slate-900 transition-colors">Suresh</a>
              </span>
            </div>
          </div>
        </div>
